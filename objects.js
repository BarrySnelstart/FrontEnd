...
const barryOpbject = {
  ...
  achternaam: "Kramer" ,
  leeftijd: 48,
  geboortedatum: 19041974,
  }

  console.log(barryOpbject);

// ===  Opdracht 2 ===
// Zorg ervoor dat de volgende string in de terminal wordt gelogd:
// "Hoi! Ik ben <voornaam>, ik ben <leeftijd> jaar oud."
console.log("Hoi! Ik ben " +barryOpbject.voornaam + " ik ben " + barryOpbject.leeftijd + " jaar oud.")
...
const stringOfProduct = "De " + product.productName + " is gemaakt van " + product.material[0] +" en " + product.material[1];
