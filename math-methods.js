...
const diameter4 = Math.PI * 4
console.log(diameter4);
...
const dimater12 = Math.PI * 12

console.log(Math.round(dimater12));
...
if (random < 0.5) {
    console.log("Het getal is : " + random.toFixed(2) +" Het glas is halfvol");
} else
    console.log ("Het getal is : " + random.toFixed(2) +" Het glas is halfleeg");
