...
// ==========================================
console.log("mijn naam is " + name + " mijn ogen zijn " +eyeColor +" van kleur, en mijn leeftijd is " +age + " jaren oud. Mijn huidige beroep is " +beroep +
    " schoenmaat van :" +shoeSize + " en mijn relatie status is " +partner + " en we hebben" +numberOfChildren +" kinderen");
